...
//    MainActivity m = new MainActivity();
    ...
    public View onCreateView(LayoutInflater inflater, ViewGroup container,
        ...
        rootView = inflater.inflate(R.layout.voice_layout, container, false);

        RecyclerView recyclerView= (RecyclerView) rootView.findViewById(R.id.voice_recyclerview);

        titleAmh.clear();
        titleEn.clear();
        desc.clear();
        iconsId.clear();
        titleAmh.add("voice ጥቅል");
